        ...
        <div className="space-y-14">
            <div className=''>
                <svg className="mx-auto block ml-56" width="800" height="150" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <text className="font-bungee" fontSize="48" fill="#784313">
                ...
                <div className="w-full max-w-6xl bg-primary bg-opacity-10 p-6 rounded-xl shadow-md flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1 flex justify-center">
                        <Swiper
                            ...
                            navigation
                            className="rounded-lg shadow-lg overflow-hidden w-[500px]"
                        >
                            {tortoise.images.map((img, index) => (
                                <SwiperSlide key={index} className="flex justify-center items-center">
                                    <img className='w-[500px] h-[350px] object-cover rounded-lg' src={img} alt="" />
                                </SwiperSlide>
                            ))}
                        </Swiper>
                    </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="flex flex-col items-center bg-primary bg-opacity-10 p-4 rounded-xl shadow-md ">
