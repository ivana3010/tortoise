...
const TopSpecies = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-10 text-primary md:mx-10'>
        <h1 className='text-[27px] font-medium'>Popular Tortoise Species</h1>
        <div className='w-full grid grid-cols-auto gap-10 pt-10 gap-y-6 px-3 sm:px-0'>
